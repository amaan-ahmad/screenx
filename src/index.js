...
const title = "ScreenX";
const subtitle = "Online free screen recorder";

const startBtnText = "▶ Start recording ";
...
const htmlBody = () => {
  ...
  <div class="header"> 
    ...
    <p class="subtitle">${subtitle}</p>
        <p>Built with ❤ by <a href="https://amaan.codes" target="_blank">Amaan Ahmad</a></p>
  ...
  <div class="container">
      ...
      <footer>
        <a href="https://twitter.com/amaancodes" target="_blank">
          ${twitterIcon()}
        </a>
        <a href="https://github.com/amaan-ahmad/screenx" target="_blank">
          ${githubIcon()}
        </a>
        <a href="https://www.linkedin.com/in/amaan05/" target="_blank">
          ${linkedinIcon()}
        </a>
      </footer>
      `;
